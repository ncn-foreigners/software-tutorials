...
`nonprobsvy` (commit
`0dcfe9902ab943c7f1350b53a93514888a2150c8`).
...
remotes::install_github("ncn-foreigners/nonprobsvy@0dcfe9902ab943c7f1350b53a93514888a2150c8")
...
res_s1 <- nonprob(selection = ~ x1 + x2 + x3 + x4,
                  ...
                  weights = sample_nonprob$w_naive,
                  data = sample_nonprob,
